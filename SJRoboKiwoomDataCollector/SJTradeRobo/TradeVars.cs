...
namespace SJTradeRobo
{
    class TradeVars
    {
        public const string APP_NAME = "SJTradeRobo";
        public const int TV_STS_CONNECTED = 0;
        public const int TV_STS_NOTCONNECTED = -1;


        public const int MSG_STATE_UPDATE     =  1000;
